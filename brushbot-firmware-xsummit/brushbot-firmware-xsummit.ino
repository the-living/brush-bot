...
static float limit_top = 1340.0; //distance to top motor axle centers
static float limit_bottom = -1337.0; //distance to bottom motor axle centers
static float limit_right = 1173.0; //distance to right motor axle centers
static float limit_left = -1173.0; //distance to left motor axle centers
...
float initStringLength = 1716.0259; //initial string length out
...
static void processCommand() {
  ...
  switch ( cmd ) {
    ...
    case 8: {
      long positions[4];
      positions[0] = parsenumber( 'A', laststep1 );
      positions[1] = parsenumber( 'B', laststep2 );
      positions[2] = parsenumber( 'C', laststep3 );
      positions[3] = parsenumber( 'D', laststep4 );
    ...
    case 9: {
      m1.move(parsenumber( 'A', 0 )); m2.move(parsenumber( 'B', 0 )); m3.move(parsenumber( 'C', 0 )); m4.move(parsenumber( 'D', 0 ));
      steppers.runSpeedToPosition();
    }
    case 10: {
        m1.move(parsenumber( 'S', 0 )); m1.runToPosition(); break; //jog M1 stepper forward
      }
    case 11: {
        m1.move(parsenumber( 'S', 0 )); m1.runToPosition(); break; //jog M1 stepper forward
      }
    ...
    case 20: {
        m2.move(parsenumber( 'S', 1 )); m2.runToPosition(); break; //jog M2 stepper forward
      }
    case 21: {
        m2.move(parsenumber( 'S', 1 )); m2.runToPosition(); break; //jog M2 stepper forward
      }
    ...
    case 30: {
        m3.move(parsenumber( 'S', 1 )); m3.runToPosition(); break; //jog M3 stepper forward
      }
    case 31: {
        m3.move(parsenumber( 'S', 1 )); m3.runToPosition(); break; //jog M3 stepper forward
      }
    ...
    case 40: {
        m4.move(parsenumber( 'S', 1 )); m4.runToPosition(); break; //jog M4 stepper forward
      }
    case 41: {
        m4.move(parsenumber( 'S', 1 )); m4.runToPosition(); break; //jog M4 stepper forward
      }
